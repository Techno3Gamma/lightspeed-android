...
import com.t3g.lightspeed.util.PreferenceUtils;
...
public class App extends Application
{
    ...
    public static final String ACTION_REQUEST_PREFERENCES_SYNC = "com.t3g.intent.action.REQUEST_PREFERENCES_SYNC";
