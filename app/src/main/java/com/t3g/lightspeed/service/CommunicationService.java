...
import com.t3g.lightspeed.app.Service;
import com.t3g.lightspeed.config.AppConfig;
import com.t3g.lightspeed.config.Keyword;
import com.t3g.lightspeed.database.AccessDatabase;
import com.t3g.lightspeed.exception.AssigneeNotFoundException;
import com.t3g.lightspeed.exception.ConnectionNotFoundException;
import com.t3g.lightspeed.exception.DeviceNotFoundException;
import com.t3g.lightspeed.exception.TransferGroupNotFoundException;
import com.t3g.lightspeed.fragment.FileListFragment;
import com.t3g.lightspeed.object.NetworkDevice;
import com.t3g.lightspeed.object.TextStreamObject;
import com.t3g.lightspeed.object.TransferGroup;
import com.t3g.lightspeed.object.TransferInstance;
import com.t3g.lightspeed.object.TransferObject;
import com.t3g.lightspeed.util.AppUtils;
import com.t3g.lightspeed.util.CommunicationBridge;
import com.t3g.lightspeed.util.CommunicationNotificationHelper;
import com.t3g.lightspeed.util.DynamicNotification;
import com.t3g.lightspeed.util.FileUtils;
import com.t3g.lightspeed.util.HotspotUtils;
import com.t3g.lightspeed.util.NetworkDeviceLoader;
import com.t3g.lightspeed.util.NetworkUtils;
import com.t3g.lightspeed.util.NotificationUtils;
import com.t3g.lightspeed.util.NsdDiscovery;
import com.t3g.lightspeed.util.TimeUtils;
...
public class CommunicationService extends Service
{
    ...
    public static final String ACTION_FILE_TRANSFER = "com.genonbeta.lightspeed.action.FILE_TRANSFER";
    public static final String ACTION_CLIPBOARD = "com.genonbeta.lightspeed.action.CLIPBOARD";
    public static final String ACTION_CANCEL_INDEXING = "com.genonbeta.lightspeed.action.CANCEL_INDEXING";
    public static final String ACTION_IP = "com.genonbeta.lightspeed.action.IP";
    public static final String ACTION_END_SESSION = "com.genonbeta.lightspeed.action.END_SESSION";
    public static final String ACTION_SEAMLESS_RECEIVE = "com.genonbeta.intent.action.SEAMLESS_START";
    public static final String ACTION_CANCEL_JOB = "com.genonbeta.lightspeed.transaction.action.CANCEL_JOB";
    public static final String ACTION_TOGGLE_SEAMLESS_MODE = "com.genonbeta.lightspeed.transaction.action.TOGGLE_SEAMLESS_MODE";
    public static final String ACTION_REVOKE_ACCESS_PIN = "com.genonbeta.lightspeed.transaction.action.REVOKE_ACCESS_PIN";
    public static final String ACTION_TOGGLE_HOTSPOT = "com.genonbeta.lightspeed.transaction.action.TOGGLE_HOTSPOT";
    public static final String ACTION_REQUEST_HOTSPOT_STATUS = "com.genonbeta.lightspeed.transaction.action.REQUEST_HOTSPOT_STATUS";
    public static final String ACTION_HOTSPOT_STATUS = "com.genonbeta.lightspeed.transaction.action.HOTSPOT_STATUS";
    public static final String ACTION_DEVICE_ACQUAINTANCE = "com.genonbeta.lightspeed.transaction.action.DEVICE_ACQUAINTANCE";
    public static final String ACTION_SERVICE_STATUS = "com.genonbeta.lightspeed.transaction.action.SERVICE_STATUS";
    public static final String ACTION_SERVICE_CONNECTION_TRANSFER_QUEUE = "com.genonbeta.lightspeed.transaction.action.SERVICE_CONNECTION_TRANSFER_QUEUE";
    public static final String ACTION_TASK_STATUS_CHANGE = "com.genonbeta.lightspeed.transaction.action.TASK_STATUS_CHANGE";
    public static final String ACTION_TASK_RUNNING_LIST_CHANGE = "com.genonbeta.lightspeed.transaction.action.TASK_RUNNNIG_LIST_CHANGE";
    public static final String ACTION_REQUEST_TASK_STATUS_CHANGE = "com.genonbeta.lightspeed.transaction.action.REQUEST_TASK_STATUS_CHANGE";
    public static final String ACTION_REQUEST_TASK_RUNNING_LIST_CHANGE = "com.genonbeta.lightspeed.transaction.action.REQUEST_TASK_RUNNING_LIST_CHANGE";
    public static final String ACTION_INCOMING_TRANSFER_READY = "com.genonbeta.lightspeed.transaction.action.INCOMING_TRANSFER_READY";
    public static final String ACTION_TRUSTZONE_STATUS = "com.genonbeta.lightspeed.transaction.action.TRUSTZONE_STATUS";
    public static final String ACTION_REQUEST_TRUSTZONE_STATUS = "com.genonbeta.lightspeed.transaction.action.REQUEST_TRUSTZONE_STATUS";
    public static final String ACTION_TOGGLE_WEBSHARE = "com.genonbeta.lightspeed.transaction.action.TOGGLE_WEBSHARE";
    public static final String ACTION_WEBSHARE_STATUS = "com.genonbeta.lightspeed.transaction.action.WEBSHARE_STATUS";
    public static final String ACTION_REQUEST_WEBSHARE_STATUS = "com.genonbeta.lightspeed.transaction.action.REQUEST_WEBSHARE_STATUS";
