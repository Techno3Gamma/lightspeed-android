...
import com.t3g.lightspeed.dialog.SelectAssigneeDialog;
import com.t3g.lightspeed.dialog.ToggleMultipleTransferDialog;
import com.t3g.lightspeed.dialog.TransferInfoDialog;
import com.t3g.lightspeed.fragment.TransferFileExplorerFragment;
        ...
        implements PowerfulActionModeSupport, SnackbarSupport
{
    ...
    public static final String ACTION_LIST_TRANSFERS = "com.t3g.lightspeed.action.LIST_TRANSFERS";
...
// Instantiate an AdView object.
        ...
        LinearLayout adContainer = (LinearLayout) findViewById(R.id.banner_container_transfer);
        ...
        adView.setAdListener(new AdListener() {
            ...
            public void onError(Ad ad, AdError adError) {
                // Ad error callback
//                Toast.makeText(ViewTransferActivity.this, "Error: " + adError.getErrorMessage(),
